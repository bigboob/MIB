 ...
 *
 * This file is part of MIB/MIB-sdk.
 *
 * MIB/MIB-sdk is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * MIB/MIB-sdk is distributed in the hope that it will be useful,
...
import pt.ua.MIB.sdk.utils.QueryParseException;
import pt.ua.MIB.sdk.utils.RetrievalException;
import pt.ua.MIB.sdk.datastructs.dim.DimLevel;
 ...
 * @author fmvalente
 */
public interface QueryInterface extends MIBPlugin 
{
    /**
